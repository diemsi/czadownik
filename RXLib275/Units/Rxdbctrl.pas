...
uses SysUtils, Dialogs, ExtCtrls, DbConsts, {$IFDEF RX_D5}RxAppUtils{$ELSE}AppUtils{$ENDIF}, VCLUtils, // Alex
  DbUtils, {$IFNDEF RX_D3} BdeUtils, {$ENDIF} PickDate, RxCalc, MaxMin,
  RxDConst
  , RXCConst,   // Polaris
  {$IFDEF RX_D6} Variants, RxStrUtils {$ELSE} StrUtils {$ENDIF}; // Polaris
